...
<div
	class="form-control w-fit items-center absolute bottom-6 right-6 shadowlg rounded-full ring ring-[2px] ring-primary hover:ring-accent">
	<label class="swap swap-rotate bg-base-200 rounded-full p-2">
		<input
			type="checkbox"
			checked={myTheme}
			on:change={(event) => {
