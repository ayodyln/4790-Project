...
<div
	class="form-control w-fit items-center absolute bottom-6 right-6 shadowlg rounded-full ring ring-[2px] ring-primary hover:ring-accent cursor-pointer">
	<label class="swap swap-rotate bg-base-200 rounded-full p-2 cursor-pointer">
		...
		<svg
			id="light"
			class="swap-on fill-current w-10 h-10 pointer-events-none"
		...
		<svg
			id="dark"
			class="swap-off fill-current w-10 h-10 pointer-events-none"
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 24 24"
			on:click={(e) => {
				e.stopPropagation()
