<script>
	...
	let heroContent = {
		...
		urls: [
			{
				type: 'detail',
				url: 'http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=8a51610a0e82d6d4414b79e79a8bf29a'
			},
			{
				type: 'wiki',
				url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=8a51610a0e82d6d4414b79e79a8bf29a'
			},
			{
				type: 'comiclink',
				url: 'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=8a51610a0e82d6d4414b79e79a8bf29a'
			}
		]
	}
						...
						<div class="flex flex-col gap-3">
							<section class="flex gap-2">
								...
								<span>
									...
									<p>Last Updated: {heroContent.modified}</p>
									<div class="divider m-0 h-1" />
									<a
										class="btn btn-primary btn-sm mt-2"
										href={heroContent.urls[2].url}
										target="_blank"
